...
class Swiper extends Widget
{
    ...
    /**
     * @var string[] array of behaviors, which are required.
     *
     ...
     *               - [[\romkaChev\yii2\swiper\Swiper::BEHAVIOR_PAGINATION]]
     *               - [[\romkaChev\yii2\swiper\Swiper::BEHAVIOR_SCROLLBAR]]
     *               - [[\romkaChev\yii2\swiper\Swiper::BEHAVIOR_NEXT_BUTTON]]
     *               - [[\romkaChev\yii2\swiper\Swiper::BEHAVIOR_PREV_BUTTON]]
     *               - [[\romkaChev\yii2\swiper\Swiper::BEHAVIOR_RTL]]
     *               - [[\romkaChev\yii2\swiper\Swiper::BEHAVIOR_PARALLAX]]
     *
     ...
     * @see \romkaChev\yii2\swiper\Swiper::BEHAVIOR_RTL
     * @see \romkaChev\yii2\swiper\Swiper::BEHAVIOR_PARALLAX
     */
    public $behaviors = [];
    ...
    protected $availableBehaviors = [
        self::BEHAVIOR_PAGINATION,
        self::BEHAVIOR_SCROLLBAR,
        self::BEHAVIOR_NEXT_BUTTON,
        self::BEHAVIOR_PREV_BUTTON,
        self::BEHAVIOR_RTL,
        self::BEHAVIOR_PARALLAX
    ];


    /**
     * Named alias for [[\romkaChev\yii2\swiper\Swiper::$behaviors]] parallax item
     *
    ...
    /**
     * Named alias for [[\romkaChev\yii2\swiper\Swiper::$behaviors]] pagination item
     *
     * @see \romkaChev\yii2\swiper\Swiper::$behaviors
    ...
    /**
     * Named alias for [[\romkaChev\yii2\swiper\Swiper::$behaviors]] scrollbar item
     *
     * @see \romkaChev\yii2\swiper\Swiper::$behaviors
     * @see \romkaChev\yii2\swiper\Swiper::$scrollbarOptions
     *
    ...
    /**
     * Named alias for [[\romkaChev\yii2\swiper\Swiper::$behaviors]] nextButton item
     *
     * @see \romkaChev\yii2\swiper\Swiper::$behaviors
    ...
    /**
     * Named alias for [[\romkaChev\yii2\swiper\Swiper::$behaviors]] prevButton item
     *
     * @see \romkaChev\yii2\swiper\Swiper::$behaviors
     * @see \romkaChev\yii2\swiper\Swiper::$prevButtonOptions
     *
    ...
    /**
     * Named alias for [[\romkaChev\yii2\swiper\Swiper::$behaviors]] rtl item
     *
     * @see \romkaChev\yii2\swiper\Swiper::$behaviors
     *
    ...
    /**
     * This function check if there is wrong behaviors
     * and call normalizing of items and every options
     *
     * @see \romkaChev\yii2\swiper\Swiper::checkBehaviors
     *
     * @see \romkaChev\yii2\swiper\Swiper::normalizeOptions
